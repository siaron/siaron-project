...
public class ClientDemo01 {
    public static void main(String[] args) throws Exception {
        ...
        FileStatus[] statuses = fs.listStatus(new Path("/user/wxl"));
        ...
        FSDataOutputStream os = fs.create(new Path("/user/wxl/test1.log"), true);
        os.write("Hello World!".getBytes());
        os.flush();
        os.close();

        // 显示在hdfs的/ user/root 下指定文件的内容
        InputStream is = fs.open(new Path("/user/wxl/test1.log"));
